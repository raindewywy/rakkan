...
| FR-05 | ระบบนำข้อมูลผู้ใช้ไปประมวลผลคำทำนาย        
| FR-06 | ระบบเลือกคำทำนายตามผลการประมวลผล 
| FR-07 | ระบบแสดงผลคำทำนายให้ผู้ใช้                            
| FR-08 | ระบบแสดงคำแนะนำที่เกี่ยวข้องกับผลการดูดวง               
| FR-09 | ผู้ใช้สามารถเริ่มดูดวงใหม่ได้              
| FR-10 | ระบบแสดงผลเหมาะสมกับ Mobile และ Desktop
...
| ID    | รายละเอียด                                                 
| ----- | ---------------------------------------------------------- 
| NFR-01 | ระบบต้องแสดงหน้าแรกและข้อมูลแนะนำเว็บไซต์
| NFR-02 | ระบบต้องให้ผู้ใช้เลือกประเภทการดูดวงได้                    
| NFR-03 | ผู้ใช้สามารถเลือกวัน/เดือน/ปีเกิดจากปฏิทิน                 
| NFR-04 | ระบบตรวจสอบว่าข้อมูลที่กรอกถูกต้องและครบถ้วน         
| NFR-05 | ระบบนำข้อมูลผู้ใช้ไปประมวลผลคำทำนาย        
| NFR-06 | ระบบเลือกคำทำนายตามผลการประมวลผล 
| NFR-07 | ระบบแสดงผลคำทำนายให้ผู้ใช้                            
| NFR-08 | ระบบแสดงคำแนะนำที่เกี่ยวข้องกับผลการดูดวง               
| NFR-09 | ผู้ใช้สามารถเริ่มดูดวงใหม่ได้              
| NFR-10 | ระบบแสดงผลเหมาะสมกับ Mobile และ Desktop
...
พัฒนา Web Application สำหรับการดูดวงที่ผู้ใช้สามารถกรอกวันเกิด เลือกประเภทการดูดวง และรับคำทำนายพร้อมคำแนะนำได้อย่างสะดวก
...
1. Homepage
2. Fortune Type Selection
3. Birth Information Input
4. Input Validation
5. Fortune Calculation
6. Fortune Generation
7. Fortune Result
8. Advice
9. Navigation
10. New Fortune
